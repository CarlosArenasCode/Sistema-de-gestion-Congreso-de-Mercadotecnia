...
CREATE TABLE usuarios (
    ...
    -- --> NUEVAS COLUMNAS PARA TÉRMINOS Y CONDICIONES
    ...
    -- --> NUEVA REGLA DE SEGURIDAD PARA T&C
...
CREATE TABLE asistencias (
    ...
    CONSTRAINT uk_asistencia_usuario_evento UNIQUE (id_usuario, id_evento)
);

COMMENT ON TABLE asistencias IS 'Tabla de registro de asistencia a eventos';
COMMENT ON COLUMN asistencias.duracion IS 'Duración calculada entre entrada y salida';
