...
COMMENT ON TABLE password_reset_tokens IS 'Tabla de tokens para recuperación de contraseña';
...
-- Índices en tabla password_reset_tokens
CREATE INDEX idx_reset_selector ON password_reset_tokens(selector);
CREATE INDEX idx_reset_expiracion ON password_reset_tokens(fecha_expiracion);
